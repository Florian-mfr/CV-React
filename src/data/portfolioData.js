export const portfolioData = [
    ...
    },
    {
        id: 4,
        name: "So Pekocko",
        languages: ["NodeJS", "MongoDB", "JavaScript"],
        languagesIcons: ["fab fa-node", "fas fa-database", "fab fa-js"],
        source: "https://github.com/Florian-mfr/OC_SoPekocko",
        info: "Implémentation d'un serveur backend à l'aide de NodeJS/Express et création d'une base de données MongoDB. Création/connexion d'un utilisateur, ajout/modification de contenu.",
        picture: "./media/img-sopekocko.png"
    },
    {
        id: 3,
        name: "Orinoco",
